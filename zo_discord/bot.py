...
class ButtonCallbackView(ui.View):
    ...
    def _make_callback(self, label: str, button_id: str):
        async def callback(interaction: discord.Interaction):
            ...
            if conv_id:
                memory_session_title = await resolve_memory_session_title(self.thread_id)
...
class ZoDiscordBot(commands.Bot):
    ...
    async def handle_channel_message(self, message: discord.Message):
        ...
        memory_session_title = f"discord-thread-{thread_id}"
    ...
    async def handle_thread_message(self, message: discord.Message):
        ...
        if conv_id is None:
            return
        memory_session_title = await resolve_memory_session_title(thread_id)
    ...
    async def handle_notify(self, request: web.Request) -> web.Response:
        ...
        POST /notify
        {
            ...
            "memory_session_title": "optional stable memory session title"
        }
        """
        try:
            ...
            explicit_memory_session_title = data.get("memory_session_title")
    ...
    async def handle_new_thread(self, request: web.Request) -> web.Response:
        ...
        try:
            ...
            memory_session_title = f"discord-thread-{thread.id}"
